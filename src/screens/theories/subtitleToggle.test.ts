...
describe('uso estático de CC en Teoría 6', () => {
  const source = readFileSync(new URL('./LoopAccumulatorTheoryScreen.svelte', import.meta.url), 'utf8');
...
describe('uso estático de CC en Teoría 7', () => {
  const source = readFileSync(new URL('./StackLifoTheoryScreen.svelte', import.meta.url), 'utf8');
